...
class Binop(ExpBase):
    ...
    def eval(self, builder):
        if(self.op == 'add'):
            builder.add(self.lhs, self.rhs, name = ".binop_add")
            pass
        else if(self.op == "sub"):
            builder.sub(self.lhs, self.rhs, name = ".binop_sub")
            pass
        else if(self.op == "mul"):
            builder.mul(self.lhs, self.rhs, name = ".binop_mul")
            pass
        else if(self.op == "div"):
            builder.sdiv(self.lhs, self.rhs, name = ".binop_sdiv")
            pass
...
class Blk(ExpBase):
    ...
    def __str__(self):
        ...
        return s
    def eval(self, fn):
        #fn_block = fn.append_basic_block( name="fn_fib_entry" )
...
class Func(ExpBase):
    ...
    def eval(self):
        ...
        fn_type = ir.FunctionType(typeMap[self.ret_type], [typeMap[vdecl.type] for vdecl in vdecls.vars])
